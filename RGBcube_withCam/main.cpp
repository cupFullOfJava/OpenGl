...
|******************************************************************************|
| Edited to Display a 3D Cube by Jeremy Timothy Brown						   |
|******************************************************************************|	
| Virtual Camera - create and modify VIEW and PROJECTION matrices              |
| keyboard controls: W,S,A,D, left & right arrows, page up and down buttons    |
\******************************************************************************/
...
/*------------------------------create geometry-------------------------------*/
	...
	glBufferData (GL_ARRAY_BUFFER, 9 * 12 * sizeof (GLfloat), points, GL_STATIC_DRAW);
	
	GLuint colours_vbo;
	glGenBuffers (1, &colours_vbo);
	glBindBuffer (GL_ARRAY_BUFFER, colours_vbo);
	glBufferData (GL_ARRAY_BUFFER, 9 * 12 * sizeof (GLfloat), colours, GL_STATIC_DRAW);
